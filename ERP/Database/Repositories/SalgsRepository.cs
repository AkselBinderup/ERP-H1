...
public class SalgsRepository : SemiCommonDBModule<SalgsOrdreHoved>, IDBrepository<SalgsOrdreHoved>
{
    ...
    public List<SalgsOrdreHoved> Read()
    {
        var salgsListe = Reader<SalgsOrdreHoved>($"SELECT dbo.SalgsOrdreHoved.*, dbo.Kunde.PersonId, dbo.Person.FuldeNavn, " +
            $"dbo.Produkt.VareNummer, dbo.Produkt.Navn AS ProduktNavn, dbo.Produkt.Beskrivelse, dbo.Produkt.SalgsPris, " +
            $"dbo.Produkt.IndkøbsPris, dbo.Produkt.Lokation, dbo.Produkt.AntalLager, dbo.Produkt.Enhed " +
            ...
            $"JOIN dbo.Produkt ON dbo.SalgsOrdreHoved.VareNummer = dbo.Produkt.VareNummer");
