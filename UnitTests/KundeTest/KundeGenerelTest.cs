...
public class KundeGenerelTest
{
    ...
    public void KundeInfoScreenUnitTest()
    {
        ...
        Kunde jon = new Kunde { KundeNummer = 1, Fornavn = "Jon", Efternavn = "Hedegaard", TelefonNummer = 88888888, Email = "Jon@gmail.com", Adresse = adresseEksempel, SidsteKøb = DateTime.Now };
